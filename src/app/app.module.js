...
AppModule = __decorate([
  NgModule({
      declarations: [
          AppComponent, HelloComponent, StudentComponent, DosenComponent, HomeComponent, AboutComponent
      ],
      imports: [
          BrowserModule, HttpClientModule, FormsModule, BrowserAnimationsModule, MatToolbarModule,
